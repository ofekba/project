...
def cal_cross_linking_percent(time_step_to_cal, axis_x, axis_y, file_name, start_time_step):
	...
	for i in range(len(text_list)):
		...
		if len(ln)>2:
			if ln[1]=="Timestep" and (int(ln[2])%time_step_to_cal)==0:
				...
				axis_x.append(time_step+start_time_step)
...
axis_x=[]
axis_y=[]
cal_cross_linking_percent(50000, axis_x, axis_y, "bonds0.reax", 0)
cal_cross_linking_percent(50000, axis_x, axis_y, "bonds1.reax", 2000000)
cal_cross_linking_percent(50000, axis_x, axis_y, "bonds2.reax", 3000000)
cal_cross_linking_percent(50000, axis_x, axis_y, "bonds3.reax", 4000000)
